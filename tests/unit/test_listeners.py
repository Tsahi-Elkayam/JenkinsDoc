...
class TestJenkinsDocHoverCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.jenkins_data = {
            ...
            'directives': [{
                'name': 'agent',
                'description': 'Specify where to run',
...
class TestJenkinsCompletions(unittest.TestCase):
    ...
    def test_get_instruction_completions_no_prefix(self):
        ...
        completions = self.completions._get_instruction_completions(
            self.jenkins_data, self.settings, ""
        )
    ...
    def test_get_instruction_completions_with_prefix(self):
        ...
        completions = self.completions._get_instruction_completions(
            self.jenkins_data, self.settings, "s"
        )
    ...
    def test_get_instruction_completions_with_parameters(self):
        ...
        completions = self.completions._get_instruction_completions(
            self.jenkins_data, self.settings, "sh"
        )
    ...
    def test_get_instruction_completions_without_parameters(self):
        ...
        completions = self.completions._get_instruction_completions(
            self.jenkins_data, self.settings, "echo"
        )
    ...
    def test_get_env_completions_without_prefix(self):
        ...
        completions = self.completions._get_env_completions(
            self.jenkins_data, include_prefix=True
        )
    ...
    def test_get_env_completions_with_prefix(self):
        ...
        completions = self.completions._get_env_completions(
            self.jenkins_data, include_prefix=False
        )
    ...
    def test_get_parameter_completions(self):
        ...
        line = "stage('test') { sh("
        completions = self.completions._get_parameter_completions(
            self.jenkins_data, line
        )
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_get_completions_with_empty_data(self):
        ...
        completions = completions_inst._get_instruction_completions(
            empty_data, Mock(), ""
        )
    ...
    def test_parameter_completions_for_nonexistent_function(self):
        ...
        completions_inst = listeners.JenkinsCompletions()
        utils.set_jenkins_data({
            'instructions': [{'command': 'echo', 'parameters': []}]
        })

        completions = completions_inst._get_parameter_completions(
            None, "nonExistent("
        )
